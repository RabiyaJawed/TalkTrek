          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="index.php#courses-section" class="nav-link">Languages</a></li>
                <li><a href="index.php#programs-section" class="nav-link">Features</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled footer-links">
              <li><a href="index.php#home-section" class="nav-link">Home</a></li>
              <li><a href="index.php#courses-section" class="nav-link">Language</a></li>
              <li><a href="index.php#programs-section" class="nav-link">Features</a></li>
              <li><a href="index.php#teachers-section" class="nav-link">About Us</a></li>
            </ul>
          </div>
